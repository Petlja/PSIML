...
# ## Preparing data
#
# We will use CIFAR-10 dataset from https://www.cs.toronto.edu/~kriz/cifar.html, which we load by
# calling a utility function. Please download the data from CIFAR-10 website, and make sure to
# specify correct location in `cifar10_dir` below.
...
pretrained_meta_graph = r'mobilenet_v2_1.0_224\mobilenet_v2_1.0_224.meta'
pretrained_checkpoint = r'mobilenet_v2_1.0_224\mobilenet_v2_1.0_224.ckpt'
